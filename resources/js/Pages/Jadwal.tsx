...
export default function Jadwal({ ruangans, ruanganAktif, hariJadwal, jadwalMapped }: JadwalProps) {
  ...
  return (
    <AppLayout>
      ...
      <section className="py-14 px-6 md:px-8 max-w-[1280px] mx-auto min-h-[80vh]">
        <div className="mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-[#455d97] tracking-tight">Jadwal Praktikum</h1>
          <p className="text-gray-500 text-lg">Lihat jadwal kegiatan praktikum sistem informasi berdasarkan ruangan.</p>
        </div>
            ...
            <table className="w-full border-collapse text-left text-sm">
              <thead>
                <tr className="bg-[#455d97] text-white">
                  <th className="p-4 border-b border-[#3b4f80] border-r border-[#3b4f80] font-bold w-32 text-center uppercase tracking-wider">Hari</th>
                  <th className="p-4 border-b border-[#3b4f80] border-r border-[#3b4f80] font-bold w-48 text-center uppercase tracking-wider">Jam</th>
                  <th className="p-4 border-b border-[#3b4f80] border-r border-[#3b4f80] font-bold w-[35%] text-center uppercase tracking-wider">Kelas & Angkatan</th>
                  <th className="p-4 border-b border-[#3b4f80] font-bold uppercase text-center tracking-wider">Mata Kuliah</th>
                </tr>
              </thead>
                      ...
                      <React.Fragment key={`${hari}-${jam}`}>
                        {isJumatBreak && (
                          <tr className="bg-emerald-500 text-white font-bold">
                            <td className="p-3 text-center tracking-widest text-xs" colSpan={3}>
                          ...
                          <td className="p-4 border-r border-gray-200 text-center font-medium">
                            {mappedItem ? (
                              <span className="font-bold">
                                ...
                                <span className="font-bold">{mappedItem.kelas?.angkatan}</span>
                              </span>
                            ) : (
