...
export default function Form() {
    ...
    fetch(`/api/matkul-by-angkatan?angkatan=${angkatan}`)
      ...
      .then((data) => {
        ...
        const exists = data.some(
          (m: any) => m.nama_mk === formCreate.data.matkul
        );
        if (!exists) {
          formCreate.setData('matkul', '');
        }
  ...
  useEffect(() => {
    ...
    fetchApi<{ value: string; label: string }[]>(
      `/api/jadwal-tersedia?matkul=${encodeURIComponent(formCreate.data.matkul)}`
    )
      .then((data) => {
        setJadwalList(data);
        ...
        <div className="max-w-2xl mx-auto px-6 md:px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-3 text-sm max-w-md mx-auto">
              Ajukan Surat Izin Tidak Hadir Praktikum secara cepat dan digital
              untuk ditinjau oleh asisten praktikum.
            </p>
          </div>
            ...
            <form onSubmit={handleCreateSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      formCreate.setData('email', e.target.value)
                    }
                    required
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      formCreate.setData('no_hp', e.target.value)
                    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      formCreate.setData('matkul', e.target.value)
                    }
                    required
                    disabled={
                      formCreate.data.nim.trim().length < 2 || loadingMatkul
                    }
                  ...
                  >
                    {formCreate.data.nim.trim().length < 2 ? (
                      ...
                      <option value="">
                        Tidak ada mata kuliah ditemukan untuk angkatan Anda
                      </option>
                    ) : (
                      <>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      formCreate.setData('kelas_sesi', e.target.value)
                    }
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      formCreate.setData('tanggal_praktikum', e.target.value)
                    }
                    required
                    className="w-full bg-white border border-gray-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-[#203971] outline-none"
                  />
                  ...
                  <label className="flex items-center gap-3 cursor-pointer mt-5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 font-normal">
                        Ajukan kepindahan jadwal ke sesi lainnya
                      </p>
                    </div>
                  </label>
                </div>
              ...
              {formCreate.data.request_pindah_sesi && (
                <div className="animate-fade-in bg-gray-50 border border-gray-150 p-4 rounded-xl space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      formCreate.setData('sesi_tujuan', e.target.value)
                    }
                  ...
                  >
                    {!formCreate.data.matkul ? (
                      ...
                      <option value="">
                        Tidak ada jadwal pindahan/susulan yang tersedia
                      </option>
                    ) : (
                      <>
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-400 mt-1">
                  Format file: .pdf, .jpg, .jpeg, .png (Maks 2MB) &bull; Berkas
                  ini wajib diunggah.
                </p>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl text-center space-y-4 animate-scale-up">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-gray-500 font-mono">
                Nomor Pengajuan:{' '}
                <span className="font-bold text-[#203971]">
                  {successPengajuan.nomor_pengajuan}
                </span>
              </p>
            </div>

            <p className="text-sm text-gray-600 leading-relaxed">
              Pengajuan surat izin atas nama{' '}
              <strong>{successPengajuan.nama}</strong> telah diterima. Admin
              asisten laboratorium akan meninjau berkas Anda. Jika disetujui,
              surat keputusan resmi akan dikirim otomatis ke email Anda:
              <br />
              <strong className="text-slate-800">
                📧 {successPengajuan.email}
              </strong>
            </p>
