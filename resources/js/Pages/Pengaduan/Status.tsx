            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-gray-100">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 font-mono">
                  {new Date(pengaduan.created_at).toLocaleString('id-ID')} WIB
                </p>
              </div>
              ...
              <div className="flex flex-col items-start md:items-end gap-1.5">
                ...
                <div
                  className={`px-4 py-1.5 rounded-full text-xs font-black font-mono tracking-widest border uppercase ${getStatusColor(pengajuanStatus(pengaduan.status))}`}
                >
                  {pengaduan.status}
                </div>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-emerald-800">
                      Tanggapan Asisten Laboratorium
                    </h4>
                    <p className="text-xs text-emerald-600/80 mt-0.5">
                      Respons dikirim pada{' '}
                      {new Date(pengaduan.updated_at).toLocaleDateString(
                        'id-ID'
                      )}{' '}
                      WIB
                    </p>
              ...
              <div className="bg-amber-50/50 border border-amber-100 p-5 rounded-xl text-center space-y-2 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-600/80 mt-0.5">
                    Asisten laboratorium sedang mempelajari pengaduan Anda.
                  </p>
                </div>
              </div>
            )}
