...
export default function Form({
  ...
  useEffect(() => {
    ...
    fetchApi<{ id: number; nama_mk: string }[]>(
      `/api/matkul-by-angkatan?angkatan=${form.data.angkatan}`
    )
      .then((data) => {
        setMatkulList(data);
        ...
        <div className="max-w-2xl mx-auto px-6 md:px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-3 text-sm max-w-md mx-auto">
              Sarana untuk mendengar suara kalian—baik apresiasi maupun masukan
              berharga—terhadap Asisten Praktikum di Program Studi Sistem
            ...
            {!isPengaduanOpen ? (
              <div className="text-center py-10">
                ...
                <h3 className="text-xl font-bold text-gray-700 mb-2">
                  Form Pengaduan Ditutup
                </h3>
                <p className="text-gray-500">
                  Mohon maaf, pengisian form pengaduan saat ini sedang ditutup
                  oleh administrator.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        form.setData('mata_kuliah_id', e.target.value)
                      }
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">
                    Isi Rincian Evaluasi / Saran
                  </label>
                  <textarea
                    value={form.data.isi_pengaduan}
                    onChange={(e) =>
                      form.setData('isi_pengaduan', e.target.value)
                    }
                    required
                    rows={6}
                ...
                <div>
                  ...
                  <p className="text-[11px] text-gray-400 mt-1">
                    Maksimum ukuran file: 3MB (.pdf, .jpg, .jpeg, .png)
                  </p>
                ...
                <div className="border-t border-gray-150 pt-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setData('nama_pelapor', e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setData('nim_pelapor', e.target.value)
                        }
                  ...
                  <p className="text-[11px] text-gray-400 mt-2.5">
                    * Boleh dikosongkan. Pengaduan Anda tetap akan kami terima
                    secara anonim.
                  </p>
                </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl text-center space-y-4 animate-scale-up">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Masukan Anda akan dikumpulkan dan dibahas pada rapat evaluasi
              aslab berikutnya sebagai bahan evaluasi bersama. Terima kasih atas
              kepedulian Anda!
            </p>
