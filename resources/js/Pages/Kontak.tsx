...
export default function Kontak({ isPengaduanOpen = true }: { isPengaduanOpen?: boolean }) {
  return (
    <AppLayout>
        ...
        <div className="sosmed-container max-w-[1024px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="rounded-xl p-6 text-white relative overflow-hidden flex flex-col justify-between min-h-[180px] shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 group" style={{ backgroundColor: '#203971' }}>
              ...
              {/* Instagram Logo SVG */}
              <svg className="absolute -bottom-3 -right-3 w-28 h-28 opacity-10 rotate-12 group-hover:scale-110 transition-transform duration-500 pointer-events-none" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="rounded-xl p-6 text-white relative overflow-hidden flex flex-col justify-between min-h-[180px] shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 group" style={{ backgroundColor: '#e53935' }}>
              ...
              <div className="mt-5 relative z-10">
                {isPengaduanOpen ? (
                  <Link href="/pengaduan" className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 transition-colors px-5 py-2 rounded-lg font-bold text-xs tracking-wide">
                    Buka Form Pengaduan <span className="material-symbols-outlined text-sm group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform">north_east</span>
                  </Link>
                ) : (
                  <span className="inline-flex items-center gap-2 bg-black/20 hover:bg-black/30 transition-colors px-5 py-2 rounded-lg font-bold text-xs tracking-wide cursor-not-allowed">
                    Form sudah ditutup <span className="material-symbols-outlined text-sm">lock</span>
                  </span>
                )}
              </div>
              {/* Praktisi Logo */}
            ...
            <div className="rounded-xl p-6 text-white relative overflow-hidden flex flex-col justify-between min-h-[180px] shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 group" style={{ backgroundColor: '#37474f' }}>
              ...
              <div className="mt-5 relative z-10">
                <div className="mt-5 relative z-10">
                  ...
                  <a href="https://github.com/Praktikum-Sistem-Informasi"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 transition-colors px-5 py-2 rounded-lg font-bold text-xs tracking-wide"
                  >
                    Kunjungi GitHub <span className="material-symbols-outlined text-sm group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform">north_east</span>
                  </a>
                </div>
              </div>
              {/* GitHub Logo SVG */}
