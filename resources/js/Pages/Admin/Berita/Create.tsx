...
export default function Create() {
  ...
  return (
    <AdminLayout 
      ...
      subtitle="Tulis dan publikasikan berita atau pengumuman baru untuk mahasiswa."
    >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="px-8 py-5 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
              ...
              <button 
                type="submit" 
                disabled={processing}
                className="bg-[#203971] hover:bg-[#152a55] text-white px-6 py-2.5 font-bold rounded-lg shadow-md transition-all flex items-center gap-2 cursor-pointer disabled:opacity-80"
              >
                <span className="material-symbols-outlined text-sm">
                  {processing ? 'progress_activity' : 'publish'}
                </span> 
