...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Terima kasih telah menyampaikan pengaduan atau aspirasi Anda di platform Web PRAKTISI. Laporan Anda telah kami catat dengan rincian berikut:</p>
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="value">{{ $pengaduan->kategori }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value">{{ $pengaduan->created_at->format('d-m-Y H:i') }} WIB</td>
                </tr>
            </table>

            <p>Asisten laboratorium akan segera meninjau laporan Anda. Anda dapat memantau respons asisten dan status tiket secara real-time melalui tautan berikut:</p>
            <div style="text-align: center;">
                <a href="{{ url('/pengaduan/cek-status') }}" class="btn">Cek Status Pengaduan</a>
            </div>
        </div>
        <div class="footer">
